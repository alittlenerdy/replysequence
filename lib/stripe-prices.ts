...
// Separated from lib/stripe.ts so they can be imported client-side
// (lib/stripe.ts throws if STRIPE_SECRET_KEY is missing, which it always is in the browser)
