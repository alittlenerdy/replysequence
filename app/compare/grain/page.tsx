...
export default function GrainComparisonPage() {
  ...
  return (
    <div className="min-h-screen bg-[#060B18] light:bg-white">
          ...
          >
            ...
            >
              ...
              <ul className="text-gray-300 light:text-gray-600 leading-relaxed space-y-2 text-sm">
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> You want meetings to auto-generate follow-ups, sequences, and next steps</li>
                ...
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> You want next-step tracking with due dates and overdue reminders</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> You&apos;re tired of manually writing emails after every client call</li>
              </ul>
      ...
      {/* Stats Banner */}
      <AnimatedSection className="py-10 px-4 border-y border-[#6366F1]/20 bg-gradient-to-r from-[#6366F1]/5 via-[#6366F1]/5 to-[#6366F1]/5 relative">
        {/* Background glow */}
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            {[
              { value: '8 sec', label: 'AI draft time', gradient: 'from-[#6366F1] to-[#4F46E5]' },
                    ...
                    <motion.div
                      ...
                      className={`grid grid-cols-[2fr_1fr_1fr] sm:grid-cols-3 items-center py-3 px-3 sm:py-4 sm:px-4 rounded-xl transition-all duration-200 ${
                        row.winner === 'replysequence'
                          ...
                          : row.winner === 'grain'
                          ? 'bg-gradient-to-r from-gray-800/30 via-gray-800/10 to-transparent hover:from-gray-800/40 hover:via-gray-800/20 hover:-translate-y-0.5 hover:shadow-lg hover:border-[#6366F1]/30 light:from-gray-100/80 light:via-gray-50/60 light:to-transparent light:hover:from-gray-100 light:hover:via-gray-50/80 border-l-2 border-l-gray-500 border border-gray-600/30 light:border-gray-300'
            ...
            <div className="relative">
              ...
              >
                <p className="text-gray-300 light:text-gray-600 text-sm italic flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-transparent bg-clip-text bg-gradient-to-r from-[#6366F1] to-amber-400">The key question:</strong> After a meeting, do you need to share video clips with your team (Grain),
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-t from-[#6366F1]/10 via-[#6366F1]/5 to-transparent light:from-[#EEF0FF] light:via-[#EEF0FF]/50 light:to-transparent relative overflow-hidden">
        {/* Background glows */}
