  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {STATIC_PARTICLES.map((particle, i) => (
        <motion.div
          key={i}
          className="absolute w-1 h-1 light:w-2 light:h-2 bg-orange-400/30 light:bg-blue-500/40 rounded-full"
          style={{
            left: `${particle.left}%`,
            top: `${particle.top}%`,
          }}
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] light:bg-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        {/* Background effects */}
        <div className="absolute inset-0 bg-gradient-to-b from-orange-500/5 light:from-blue-400/10 via-transparent to-transparent" />
        <motion.div
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-orange-500/10 light:bg-blue-400/20 rounded-full blur-[120px]"
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-orange-500/20 to-amber-500/20 border border-orange-500/30 text-orange-300 light:text-blue-600 text-sm font-medium mb-8"
          >
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Comparison Header */}
          <div className="sticky top-0 z-10 bg-[#0a0a0f]/95 light:bg-gradient-to-r light:from-blue-50/95 light:to-orange-50/95 backdrop-blur-sm border-b border-gray-800 light:border-blue-200 mb-4">
              ...
              <motion.div
                ...
                className={`relative rounded-2xl overflow-hidden group ${
                  tier.highlighted
                    ...
                    : 'border border-gray-700 light:border-blue-200 bg-gray-900/30 light:bg-gradient-to-b light:from-blue-50/50 light:to-orange-50/30 hover:border-gray-600 light:hover:border-blue-300 light:hover:from-blue-50/80 light:hover:to-orange-50/60'
                }`}
      ...
      <AnimatedSection className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            className="relative p-8 md:p-12 rounded-3xl bg-gradient-to-br from-gray-900 via-blue-900/10 to-gray-900/50 light:from-white light:via-blue-50 light:to-orange-50 border-2 border-blue-500/30 light:border-blue-200 overflow-hidden shadow-2xl light:shadow-blue-100/50"
          ...
          >
            ...
            />
            <motion.div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-500/5 light:bg-purple-400/15 rounded-full blur-3xl"
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-t from-blue-500/10 via-purple-500/5 to-transparent light:from-blue-50 light:via-orange-50 light:to-transparent relative overflow-hidden">
        {/* Background glows */}
