  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] light:bg-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <motion.div
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-orange-500/10 rounded-full blur-[120px]"
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
      ...
      {/* Stats Banner */}
      <AnimatedSection className="py-10 px-4 border-y border-orange-500/20 bg-gradient-to-r from-orange-500/5 via-amber-500/5 to-orange-500/5 relative overflow-hidden">
        {/* Background glow */}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="sticky top-0 z-10 bg-[#0a0a0f]/95 light:bg-blue-50/95 backdrop-blur-sm border-b border-gray-800 light:border-gray-200 mb-4">
            <div className="grid grid-cols-3 py-4">
              ...
              <div className="text-center">
                <span className="text-orange-400 font-bold text-lg">Fireflies.ai</span>
              </div>
            </div>
          </div>
              ...
              <motion.div
                ...
                className={`relative p-6 rounded-2xl border-2 overflow-hidden group ${
                  diff.advantage === 'replysequence'
                    ...
                    : 'bg-gradient-to-br from-orange-500/10 via-amber-500/5 to-yellow-500/10 border-orange-500/40 shadow-xl shadow-orange-500/10'
                }`}
      ...
      <AnimatedSection className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            />
            <motion.div
              className="absolute bottom-0 left-0 w-48 h-48 bg-orange-500/10 rounded-full blur-3xl"
