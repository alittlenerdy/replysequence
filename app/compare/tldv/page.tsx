    ...
    <div className="min-h-screen bg-[#0a0a0f] light:bg-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          >
            <div className="w-12 h-12 rounded-xl flex items-center justify-center text-lg font-bold text-white" style={{ backgroundColor: '#EC4899' }}>tl</div>
          ...
          >
            ...
            >
              ...
              <ul className="text-gray-400 light:text-gray-600 leading-relaxed space-y-2 text-sm">
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-blue-400 flex-shrink-0 mt-0.5" /> You need unlimited free recordings and video clips</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-blue-400 flex-shrink-0 mt-0.5" /> You want timestamp-based navigation through meetings</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-blue-400 flex-shrink-0 mt-0.5" /> You need shareable video highlights for your team</li>
              </ul>
      ...
      {/* Stats Banner */}
      <AnimatedSection className="py-10 px-4 border-y border-indigo-500/20 bg-gradient-to-r from-indigo-500/5 via-indigo-400/5 to-indigo-600/5 relative">
        {/* Background glow */}
        <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/10 via-transparent to-indigo-600/10 pointer-events-none" />
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {row.winner === 'replysequence' && (
                          <motion.span
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            className="hidden sm:inline-flex px-2.5 py-1 rounded-full bg-gradient-to-r from-indigo-500 to-amber-500 text-white text-xs font-bold shadow-lg shadow-indigo-500/30"
                          >
                            Winner
                          </motion.span>
                        )}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <motion.div
                    ...
                    className="p-5 rounded-xl bg-gradient-to-br from-indigo-500/15 to-indigo-700/10 border border-indigo-500/40 mb-4 shadow-lg shadow-indigo-500/5"
                  >
                    <div className="mb-4">
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 via-indigo-400 to-indigo-600 font-bold text-sm">ReplySequence</span>
            ...
            <div className="relative">
              <div className="flex items-center gap-3 mb-6">
                <motion.div
                  ...
                  className="p-3 rounded-xl bg-gradient-to-br from-indigo-500/20 to-indigo-700/20 light:from-indigo-100 light:to-amber-100"
                >
        ...
        <AnimatedSection className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
              <Link
                href="/#waitlist"
                className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-semibold text-white bg-gradient-to-r from-indigo-500 to-amber-500 hover:from-indigo-400 hover:to-amber-400 shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-[background,box-shadow] duration-300"
              >
                Join the Waitlist
