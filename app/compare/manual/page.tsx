    ...
    <div className="min-h-screen bg-[#060B18] light:bg-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          >
            <p className="text-xs font-semibold text-gray-500 light:text-[#6366F1] uppercase tracking-wider mb-3">The reality</p>
          ...
          >
            ...
            >
              ...
              <ul className="text-gray-300 light:text-gray-600 leading-relaxed space-y-2 text-sm">
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> You have more than 5 meetings a week</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> Follow-ups, next steps, or deal risks slip through the cracks</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> You want personalized follow-ups, automated sequences, and deal intelligence</li>
              </ul>
      ...
      <AnimatedSection className="py-10 px-4 border-y border-[#6366F1]/20 bg-gradient-to-r from-[#6366F1]/5 via-[#6366F1]/5 to-amber-500/5 relative">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            {[
              { value: '8 sec', label: 'vs 23 min per follow-up', gradient: 'from-[#6366F1] to-[#4F46E5]' },
              ...
              { value: '$570', label: 'monthly time cost saved', gradient: 'from-[#6366F1] to-[#4F46E5]' },
            ].map((stat, i) => (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-[80px_1fr_1fr] gap-4 px-4 pb-2">
              <div />
              <div className="text-center text-sm font-bold text-[#6366F1] light:text-[#4F46E5]">ReplySequence</div>
              ...
              >
                ...
                <motion.div
                  ...
                  className={`p-4 rounded-xl border ${
                    index <= 2
                      ? 'bg-gradient-to-r from-[#6366F1]/10 via-[#6366F1]/5 to-transparent border-[#6366F1]/30 light:from-[#EEF0FF] light:border-[#4F46E5]/30'
          ...
          >
            {keyDifferences.map((diff, index) => (
              <motion.div
                ...
                variants={staggerItem}
                whileHover={{ scale: 1.02, y: -4 }}
                className="relative p-6 rounded-2xl border-2 overflow-hidden group bg-gradient-to-br from-[#6366F1]/10 via-[#6366F1]/5 to-[#4F46E5]/10 light:from-[#EEF0FF] light:via-[#EEF0FF]/50 light:to-amber-50 border-[#6366F1]/40 light:border-[#4F46E5]/40 shadow-xl shadow-[#6366F1]/10 light:shadow-[#DDE1FF]/40"
                style={{ boxShadow: '0 0 30px rgba(91, 108, 255, 0.1), inset 0 1px 0 rgba(255,255,255,0.05)' }}
              >
                {/* Stat badge */}
                <motion.div
                  whileHover={{ scale: 1.1 }}
                  className="absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-bold bg-[#6366F1]/20 light:bg-[#DDE1FF] text-[#6366F1] light:text-[#4F46E5]"
                >
                  {diff.stat}
                </motion.div>
                ...
                <motion.div
                  whileHover={{ rotate: 5 }}
                  className="inline-flex items-center justify-center w-12 h-12 rounded-xl mb-4 bg-[#6366F1]/20 light:bg-[#DDE1FF] text-[#6366F1] light:text-[#4F46E5]"
                >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <AnimatedSection>
            <motion.div
              ...
              className="p-8 md:p-10 rounded-2xl bg-gray-900/50 light:bg-gradient-to-br light:from-[#EEF0FF] light:to-amber-50 border border-gray-700 light:border-[#4F46E5]/30"
            >
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-lg font-bold text-[#6366F1] light:text-[#4F46E5]">ReplySequence Cost</h3>
                  </div>
                  <div className="space-y-4">
                    {[
                      { label: 'Meetings per month', value: '20' },
                      ...
                      <div key={i} className="flex justify-between items-center py-2 border-b border-[#6366F1]/20 light:border-[#4F46E5]/30 last:border-0">
                        <span className="text-sm text-gray-400 light:text-gray-500">{item.label}</span>
                        <span className="text-sm font-semibold text-[#818CF8] light:text-[#4F46E5]">{item.value}</span>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="space-y-4 text-gray-300 light:text-gray-600 leading-relaxed mb-8">
                ...
                <p>
                  <strong className="text-[#6366F1]">ReplySequence</strong> doesn&apos;t replace your judgment. You still
              ...
              >
                <p className="text-gray-300 light:text-gray-600 text-sm italic flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-transparent bg-clip-text bg-gradient-to-r from-[#6366F1] to-amber-400">The speed advantage:</strong> Research shows that
