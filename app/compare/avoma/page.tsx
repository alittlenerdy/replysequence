    ...
    <div className="min-h-screen bg-[#060B18] light:bg-white">
          ...
          >
            ...
            >
              ...
              <ul className="text-gray-300 light:text-gray-600 leading-relaxed space-y-2 text-sm">
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> Meetings should auto-generate follow-ups and multi-step sequences</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> You want next-step tracking, deal risk alerts, and health scoring</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#6366F1] flex-shrink-0 mt-0.5" /> You want all AI features at $19/mo without tier-climbing</li>
              </ul>
            ...
            >
              ...
              <div className="mt-5 flex items-center gap-2 text-gray-400 light:text-[#4F46E5] font-medium text-sm">
      ...
      <AnimatedSection className="py-10 px-4 border-y border-[#6366F1]/20 bg-gradient-to-r from-[#6366F1]/5 via-[#6366F1]/5 to-amber-500/5 relative">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            {[
              { value: '8 sec', label: 'Follow-up + sequence time', gradient: 'from-[#6366F1] to-[#4F46E5]' },
              { value: '10+ hrs', label: 'Saved per week', gradient: 'from-[#6366F1] to-amber-400' },
              { value: '3', label: 'Platforms supported', gradient: 'from-amber-400 to-amber-500' },
              { value: '$19', label: 'Pro plan / month', gradient: 'from-[#6366F1] to-[#4F46E5]' },
            ].map((stat, i) => (
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="space-y-4 text-gray-300 light:text-gray-600 leading-relaxed mb-8">
                ...
                <p>
                  <strong className="text-[#6366F1]">ReplySequence</strong> turns meetings into personalized follow-ups,
              ...
              >
                <p className="text-gray-300 light:text-gray-600 text-sm italic flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-transparent bg-clip-text bg-gradient-to-r from-[#6366F1] to-amber-400">Pro tip:</strong> If you need agenda prep and scheduling, Avoma handles that well.
