...
interface ComparisonRow {
  ...
  avoma: string | boolean;
  winner?: 'replysequence' | 'avoma' | 'tie';
  category?: string;
}
...
const comparisonData: ComparisonRow[] = [
  ...
  { feature: 'Custom Email Templates', replysequence: true, avoma: false, winner: 'replysequence', category: 'Revenue & Follow-up' },
  // Meeting Preparation
  { feature: 'Agenda Templates', replysequence: false, avoma: true, winner: 'avoma', category: 'Meeting Preparation' },
  { feature: 'Meeting Scheduling', replysequence: false, avoma: true, winner: 'avoma', category: 'Meeting Preparation' },
  { feature: 'Pre-meeting Briefs', replysequence: false, avoma: true, winner: 'avoma', category: 'Meeting Preparation' },
  // Recording & Transcription
  { feature: 'Meeting Transcription', replysequence: true, avoma: true, winner: 'tie', category: 'Recording & Transcription' },
  { feature: 'AI Meeting Notes', replysequence: true, avoma: true, winner: 'tie', category: 'Recording & Transcription' },
  { feature: 'Action Item Extraction', replysequence: true, avoma: true, winner: 'tie', category: 'Recording & Transcription' },
  { feature: 'Live Bookmarking', replysequence: false, avoma: true, winner: 'avoma', category: 'Recording & Transcription' },
  // Integrations
  { feature: 'Zoom Integration', replysequence: true, avoma: true, winner: 'tie', category: 'Integrations' },
  { feature: 'Google Meet Integration', replysequence: true, avoma: true, winner: 'tie', category: 'Integrations' },
  { feature: 'Microsoft Teams Integration', replysequence: true, avoma: true, winner: 'tie', category: 'Integrations' },
  // Pricing & Accessibility
  { feature: 'Free Tier', replysequence: true, avoma: true, winner: 'tie', category: 'Pricing & Accessibility' },
  { feature: 'Starting Price for AI', replysequence: '$19/mo', avoma: '$49/mo', winner: 'replysequence', category: 'Pricing & Accessibility' },
  { feature: 'No Feature Gating', replysequence: 'All AI features at $19', avoma: 'AI spread across tiers', winner: 'replysequence', category: 'Pricing & Accessibility' },
];
...
const keyDifferences = [
  ...
  },
  {
    ...
    description: 'All AI features at $19/month. No climbing through $49, $79, and $129 tiers to unlock the features you actually need.',
    stat: '$19/mo',
    advantage: 'replysequence' as const,
  },
  {
    icon: Calendar,
    title: 'Meeting Lifecycle Coverage',
    description: 'Avoma covers before, during, and after meetings\u2014agenda prep, scheduling, live bookmarking, and post-meeting notes all in one platform.',
    stat: 'End-to-end',
    advantage: 'avoma' as const,
  },
  {
    icon: MessageSquare,
    title: 'Coaching & Scorecards',
    description: 'Avoma offers team coaching with custom scorecards and conversation intelligence\u2014great for sales managers who need to evaluate and train reps.',
    stat: 'Team tools',
    advantage: 'avoma' as const,
  },
];
...
export default function AvomaComparisonPage() {
    ...
    <div className="min-h-screen bg-[#060B18] light:bg-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-gray-400 light:text-gray-500">Avoma</span>
          </motion.h1>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <p className="text-sm font-medium text-gray-400 light:text-gray-500 mb-1">Avoma</p>
                <p className="text-sm text-gray-300 light:text-gray-600">Manage the full meeting lifecycle&mdash;before, during, and after.</p>
              </div>
              <div>
          ...
          >
            ...
            >
              ...
              <ul className="text-gray-300 light:text-gray-600 leading-relaxed space-y-2 text-sm">
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#5B6CFF] flex-shrink-0 mt-0.5" /> Meetings should auto-generate follow-ups and multi-step sequences</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#5B6CFF] flex-shrink-0 mt-0.5" /> You want next-step tracking, deal risk alerts, and health scoring</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-[#5B6CFF] flex-shrink-0 mt-0.5" /> You want all AI features at $19/mo without tier-climbing</li>
              </ul>
              <div className="mt-5 space-y-1">
                <div className="flex items-center gap-2 text-transparent bg-clip-text bg-gradient-to-r from-[#5B6CFF] to-[#5B6CFF] font-medium text-sm">
                  ...
                  Best for: Founders / Solo sellers / SMB sales teams
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="mt-5 flex items-center gap-2 text-gray-400 light:text-[#4A5BEE] font-medium text-sm">
                <Globe className="w-4 h-4" />
                Best for: Mid-market teams needing full meeting lifecycle management
              </div>
            </motion.div>
          </motion.div>
        </div>
      ...
      <AnimatedSection className="py-10 px-4 border-y border-[#5B6CFF]/20 bg-gradient-to-r from-[#5B6CFF]/5 via-[#5B6CFF]/5 to-amber-500/5 relative">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            {[
              { value: '8 sec', label: 'Follow-up + sequence time', gradient: 'from-[#5B6CFF] to-[#4A5BEE]' },
              { value: '10+ hrs', label: 'Saved per week', gradient: 'from-[#5B6CFF] to-amber-400' },
              { value: '3', label: 'Platforms supported', gradient: 'from-amber-400 to-amber-500' },
              { value: '$19', label: 'Pro plan / month', gradient: 'from-[#5B6CFF] to-[#4A5BEE]' },
            ].map((stat, i) => (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="sticky top-0 z-10 bg-[#060B18]/95 light:bg-gradient-to-r light:from-[#EEF0FF]/95 light:to-[#EEF0FF]/95 backdrop-blur-sm border-b border-gray-800 light:border-[#4A5BEE]/30 mb-4">
            <div className="grid grid-cols-[2fr_1fr_1fr] sm:grid-cols-3 py-3 sm:py-4">
              ...
              <div className="text-center">
                <span className="text-gray-400 light:text-slate-600 font-bold text-sm sm:text-lg">Avoma</span>
              </div>
            </div>
          </div>
                ...
                {comparisonData
                  ...
                  .map((row, index) => (
                    ...
                    >
                      ...
                      <div className="flex justify-center">
                        <FeatureValue value={row.avoma} isWinner={row.winner === 'avoma'} />
                      </div>
                    </motion.div>
                  ))}
              </motion.div>
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                    ...
                    {diff.advantage === 'replysequence' ? 'ReplySequence' : 'Avoma'}
                  </span>
                </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <AnimatedSection className="text-center mb-16">
            ...
            <p className="text-gray-400 light:text-gray-500 text-lg max-w-2xl mx-auto">
              All AI features at one price vs multi-tier gating
            </p>
          </AnimatedSection>
            ...
            {pricingComparison.map((tier, index) => (
              <motion.div
                ...
                className={`relative rounded-2xl overflow-hidden group ${
                  tier.highlighted
                    ? 'border-2 border-[#5B6CFF]/50 light:border-[#4A5BEE]/40 bg-gradient-to-b from-[#5B6CFF]/10 via-[#5B6CFF]/5 to-transparent light:from-[#EEF0FF] light:via-[#EEF0FF] light:to-[#EEF0FF] shadow-xl shadow-[#5B6CFF]/10 light:shadow-[#DDE1FF]/40'
                    : 'border border-gray-700 light:border-[#4A5BEE]/30 bg-gray-900/30 light:bg-gradient-to-b light:from-[#EEF0FF]/50 light:to-[#EEF0FF]/30 hover:border-gray-600 light:hover:border-[#99A8FF] light:hover:from-[#F5F6FF]/80 light:hover:to-[#F5F6FF]/60'
                }`}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  >
                    <div className="mb-4">
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5B6CFF] to-[#5B6CFF] font-bold text-sm">ReplySequence</span>
                  ...
                  <div className="p-5 rounded-xl bg-gray-800/50 light:bg-slate-50 border border-gray-700 light:border-slate-200">
                    <div className="mb-4">
                      <span className="text-gray-400 light:text-gray-500 font-semibold text-sm">Avoma</span>
                      <div className="flex items-baseline gap-1 mt-1">
                        <span className={`font-bold text-gray-300 light:text-gray-600 ${tier.avoma.price.startsWith('$') ? 'text-2xl' : 'text-base'}`}>{tier.avoma.price}</span>
                        <span className="text-gray-500 text-sm">{tier.avoma.period}</span>
                      </div>
                    </div>
                    <ul className="space-y-2">
                      {tier.avoma.features.map((feature, i) => (
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="space-y-4 text-gray-300 light:text-gray-600 leading-relaxed mb-8">
                <p>
                  <strong className="text-white light:text-gray-900">Avoma</strong> tries to be the all-in-one meeting lifecycle
                  platform&mdash;scheduling, agendas, recording, notes, and coaching. If your team wants a single tool covering
                  every phase of every meeting, Avoma has breadth.
                </p>
                <p>
                  <strong className="text-[#5B6CFF]">ReplySequence</strong> turns meetings into personalized follow-ups,
              ...
              >
                <p className="text-gray-300 light:text-gray-600 text-sm italic flex items-start gap-3">
                  ...
                  <span>
                    <strong className="text-transparent bg-clip-text bg-gradient-to-r from-[#5B6CFF] to-amber-400">Pro tip:</strong> If you need agenda prep and scheduling, Avoma handles that well.
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "ReplySequence vs Avoma", "item": "https://www.replysequence.com/compare/avoma" }
            ]
          })
        }}
      />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              {
                "@type": "Question",
                "name": "Is ReplySequence cheaper than Avoma?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "For AI features, yes. ReplySequence Pro at $19/month includes all AI features. Avoma's AI features start at $49/month (Plus plan), with more advanced features at $79-$129/month."
                }
              },
              {
                "@type": "Question",
