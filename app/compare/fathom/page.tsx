        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <motion.div
              whileHover={{ scale: 1.02, y: -4 }}
              transition={{ type: 'spring', stiffness: 300 }}
              className="relative p-8 rounded-2xl bg-gray-900/50 light:bg-gradient-to-br light:from-slate-50 light:to-[#EEF0FF] border border-gray-700 light:border-gray-200 overflow-hidden group"
            >
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              { "@type": "ListItem", "position": 3, "name": "ReplySequence vs Fathom", "item": "https://www.replysequence.com/compare/fathom" }
            ]
          })
        }}
      />
          ...
          __html: JSON.stringify({
            ...
            "mainEntity": [
              ...
              },
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, Fathom has native integrations with HubSpot and Salesforce, automatically syncing meeting notes and action items to your CRM. ReplySequence also integrates with HubSpot, Salesforce, and Google Sheets."
                }
              },
              {
                "@type": "Question",
