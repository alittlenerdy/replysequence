    ...
    <div className="min-h-screen bg-[#0a0a0f] light:bg-white">
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          >
            <div className="w-12 h-12 rounded-xl flex items-center justify-center text-xl font-bold text-white" style={{ backgroundColor: '#7C3AED' }}>G</div>
          ...
          >
            ...
            >
              ...
              <ul className="text-gray-400 light:text-gray-600 leading-relaxed space-y-2 text-sm">
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-blue-400 flex-shrink-0 mt-0.5" /> You need deep conversation analytics and pipeline forecasting</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-blue-400 flex-shrink-0 mt-0.5" /> You want enterprise-grade coaching tools for a large sales org</li>
                <li className="flex items-start gap-2"><Check className="w-4 h-4 text-blue-400 flex-shrink-0 mt-0.5" /> You need deal scoring across your entire revenue team</li>
              </ul>
