    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <div className="h-3 w-40 bg-gray-700/60 light:bg-gray-200 rounded" />
        </div>
      ...
      <div className="h-16 bg-gray-900/50 light:bg-white border border-gray-700 light:border-gray-200 rounded-xl" />
      {/* KPI stat cards */}
      ...
      {/* At-risk meetings skeleton */}
      <div className="bg-gray-900/50 light:bg-white border border-gray-700 light:border-gray-200 rounded-2xl p-6 h-[160px]" />
      {/* Charts skeleton */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {[1, 2].map((i) => (
          <div key={i} className="bg-gray-900/50 light:bg-white border border-gray-700 light:border-gray-200 rounded-2xl p-6">
            ...
            <div className="h-[140px] bg-gray-800/50 light:bg-gray-100 rounded-lg" />
          </div>
        ))}
      </div>
    </div>
