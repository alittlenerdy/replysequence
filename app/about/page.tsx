              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.label} className="text-center py-4 border-b border-gray-800 light:border-gray-200 last:border-0">
                    <div className="text-3xl font-bold bg-gradient-to-r from-[#6366F1] to-[#4F46E5] bg-clip-text text-transparent">
                      {item.stat}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Sent emails are automatically logged to HubSpot, Salesforce, or Google Sheets. No manual data entry, no missed touchpoints.',
              },
            ].map((item) => (
