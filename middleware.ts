...
export default clerkMiddleware(async (auth, req: NextRequest) => {
  ...
  const cspDirectives = [
    ...
    "frame-src 'self' https://js.stripe.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.replysequence.com https://accounts.replysequence.com https://challenges.cloudflare.com https://demo.arcade.software https://www.loom.com",
