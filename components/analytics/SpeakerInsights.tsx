  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-900/60 border border-gray-700/50 light:bg-white light:border-gray-200 rounded-2xl p-5 light:shadow-sm">
        ...
        <div className="h-6 rounded-full overflow-hidden flex bg-gray-800/50 light:bg-gray-100 light:bg-gray-200 mb-5">
        ...
        <div className="space-y-2">
          {/* Table header */}
          <div className="grid grid-cols-[1fr_80px_70px_60px_80px] gap-2 text-xs text-gray-500 px-2 pb-1 border-b border-white/[0.06] light:border-gray-200">
            <span>Speaker</span>
          ...
          {topSpeakers.map((speaker, i) => (
            <motion.div
              ...
              className="grid grid-cols-[1fr_80px_70px_60px_80px] gap-2 items-center px-2 py-1.5 rounded-lg hover:bg-gray-800/50 light:bg-gray-100 light:hover:bg-gray-50 transition-colors"
            >
        ...
        {/* Total row */}
        <div className="mt-2 pt-2 border-t border-white/[0.06] light:border-gray-200">
