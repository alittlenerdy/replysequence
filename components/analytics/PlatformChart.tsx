...
function CustomTooltip({ active, payload }: CustomTooltipProps) {
  ...
  return (
    <div className="bg-gray-900/60 border border-gray-700/50 light:bg-white light:border-gray-200 rounded-lg px-3 py-2 shadow-xl">
              ...
              return (
                <div key={item.platform} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-1 h-1.5 bg-gray-800/50 light:bg-gray-100 light:bg-gray-200 rounded-full overflow-hidden">
                      <motion.div
                        initial={{ width: 0 }}
