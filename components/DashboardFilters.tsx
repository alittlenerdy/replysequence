      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-40">
          ...
          <select
            ...
            className="block w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          >
