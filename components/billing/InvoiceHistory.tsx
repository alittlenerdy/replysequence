    ...
    return (
      <div className="bg-gray-900/50 light:bg-white border border-gray-700 light:border-gray-200 rounded-2xl p-6">
        <div className="flex items-center gap-2 mb-4">
          <Receipt className="w-5 h-5 text-[#6366F1] light:text-[#6366F1]" />
        ...
        <div className="text-center py-8">
          ...
          {billing.tier === 'free' && (
            <button
              ...
              className="inline-flex items-center gap-2 mt-3 text-sm text-[#6366F1] hover:text-[#818CF8] transition-colors rounded outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]"
            >
                  ...
                  <td className="py-4 px-4 text-right">
                    {(invoice.pdfUrl || invoice.invoiceUrl) && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 text-sm text-[#6366F1] hover:text-[#818CF8] transition-colors rounded outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]"
                      >
