          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={handleCopy}
                  className="px-3 py-2 bg-[#4A5BEE] hover:bg-[#3A4BDD] text-white rounded-lg text-sm font-medium transition-colors flex items-center gap-1.5 outline-none focus-visible:ring-2 focus-visible:ring-[#5B6CFF]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]"
                >
                  {copied ? (
                    <>
            ...
            <div className="flex items-center justify-center gap-3 pt-2">
              <a
                ...
                className="px-4 py-2 bg-[#0077B5]/10 border border-[#0077B5]/30 text-[#0077B5] rounded-lg text-sm font-medium hover:bg-[#0077B5]/20 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#5B6CFF]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]"
              >
                Share on LinkedIn
              </a>
              <a
