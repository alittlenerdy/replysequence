      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bento-card">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6366F1] to-cyan-500 flex items-center justify-center mb-4">
          ...
          {/* Brand Voice Card */}
          <div className="bento-card">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6366F1] to-amber-500 flex items-center justify-center mb-4">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="bento-card lg:col-span-2">
            <div className="flex items-start justify-between">
              <div>
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6366F1] to-[#4F46E5] flex items-center justify-center mb-4">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="hidden md:flex items-end gap-1 h-16">
                <div className="w-4 h-6 bg-[#6366F1]/30 rounded-t" />
                <div className="w-4 h-10 bg-[#6366F1]/50 rounded-t" />
                <div className="w-4 h-8 bg-[#6366F1]/40 rounded-t" />
                <div className="w-4 h-14 bg-[#6366F1]/70 rounded-t" />
                <div className="w-4 h-16 bg-[#6366F1] rounded-t" />
              </div>
            </div>
          </div>
        </div>
