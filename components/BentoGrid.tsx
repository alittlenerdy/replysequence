      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-black mb-4 text-text-primary">
            Everything You Need to <span className="text-mint">Close Faster</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bento-card-featured lg:col-span-2 lg:row-span-2">
            <div className="flex flex-col h-full">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-mint to-neon flex items-center justify-center icon-pulse">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <span className="text-xs font-bold text-mint uppercase tracking-wider">AI-Powered</span>
              </div>
              ...
              <div className="bg-background rounded-2xl p-4 border border-black/5">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <div>
                    <div className="h-3 w-24 bg-mint/30 rounded" />
                    <div className="h-2 w-16 bg-background-alt rounded mt-1" />
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="h-3 bg-background-alt rounded w-full" />
                  <div className="h-3 bg-background-alt rounded w-5/6" />
                  <div className="h-3 bg-mint/20 rounded w-4/6" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bento-card">
            ...
            <h3 className="text-lg font-bold mb-2 text-text-primary">CRM Sync</h3>
          ...
          <div className="bento-card">
            ...
            <h3 className="text-lg font-bold mb-2 text-text-primary">Your Voice</h3>
            <p className="text-text-secondary text-sm">
          ...
          <div className="bento-card">
            ...
            <h3 className="text-lg font-bold mb-2 text-text-primary">All Platforms</h3>
            <p className="text-text-secondary text-sm">
          ...
          <div className="bento-card lg:col-span-2">
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="text-lg font-bold mb-2 text-text-primary">Smart Analytics</h3>
              ...
              <div className="hidden md:flex items-end gap-1 h-16">
                <div className="w-4 h-6 bg-mint/30 rounded-t" />
                <div className="w-4 h-10 bg-mint/50 rounded-t" />
                <div className="w-4 h-8 bg-mint/40 rounded-t" />
                <div className="w-4 h-14 bg-mint/70 rounded-t" />
                <div className="w-4 h-16 bg-mint rounded-t" />
              </div>
            </div>
          </div>
        </div>
