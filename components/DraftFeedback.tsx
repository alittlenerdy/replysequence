      ...
      <div className="flex items-center gap-2 mt-2">
        ...
        {!showFeedbackInput && (
          <button
            ...
            className="ml-auto text-xs text-gray-500 hover:text-gray-400 transition-colors rounded outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/70 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
          >
            Add a note
          </button>
        )}
      ...
      {showFeedbackInput && (
        <div className="mt-3 space-y-2">
          <textarea
            ...
            rows={2}
            aria-label="Feedback"
            className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-sm text-gray-300 placeholder-gray-500 focus-visible:border-indigo-500 focus-visible:outline-none resize-none"
          />
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 text-xs text-gray-400 hover:text-gray-300 transition-colors rounded outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/70 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900"
            >
              Cancel
            </button>
          </div>
