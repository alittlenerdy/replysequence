    ...
    >
      ...
      {!item.completed && item.actionType === 'sample' && onSampleAction && (
        <button
          ...
          className="shrink-0 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors flex items-center gap-1 bg-[#6366F1]/20 text-[#6366F1] hover:bg-[#4F46E5]/30 disabled:opacity-50 disabled:cursor-not-allowed outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]"
        >
      ...
      {!item.completed && item.actionType !== 'sample' && item.actionUrl && (
        <Link
          href={item.actionUrl}
          className={`shrink-0 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors flex items-center gap-1 outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18] ${
            item.optional
              ? 'bg-gray-700/50 text-gray-300 hover:bg-gray-700/70 light:bg-gray-200 light:text-gray-600 light:hover:bg-gray-300'
              : 'bg-[#6366F1]/20 text-[#6366F1] hover:bg-[#4F46E5]/30'
          }`}
        >
          {item.actionLabel || 'Go'}
...
function CelebrationParticle({ delay, x }: { delay: number; x: number }) {
  return (
    <motion.div
      ...
      className="absolute"
    >
      <Star className="w-4 h-4 text-[#6366F1]" fill="currentColor" />
    </motion.div>
  );
}
    ...
    >
      ...
      <div className="text-center p-6 relative">
        <motion.div
          ...
          className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-[#6366F1] to-[#3A4BDD] rounded-full flex items-center justify-center"
        >
      ...
      <div className="relative bg-gray-900/60 border border-gray-700/50 light:bg-white light:border-gray-200 rounded-2xl p-6">
        ...
        <div className="relative flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="p-2 rounded-lg hover:bg-gray-800 light:hover:bg-gray-100 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]"
