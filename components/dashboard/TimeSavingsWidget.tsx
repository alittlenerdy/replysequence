          ...
          <div className="relative space-y-6">
            ...
            <div className="text-center py-2">
              <div className="text-5xl md:text-6xl font-black mb-2">
                <span
                  className="text-[#6366F1] light:text-[#4F46E5]"
                >
            ...
            {/* Fun comparison */}
            <div
              className="flex items-center justify-center gap-2 text-[#6366F1] light:text-[#4F46E5] bg-[#6366F1]/10 rounded-lg py-2 px-4 mx-auto w-fit"
            >
              {comparison.icon}
