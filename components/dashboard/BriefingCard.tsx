      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          <div className="w-8 h-8 rounded-lg bg-indigo-500/15 flex items-center justify-center flex-shrink-0">
            <svg className="w-4 h-4 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                  ...
                  <li key={i} className="flex gap-2">
                    ...
                    <div>
                      ...
                      {tp.suggestedApproach && (
                        <p className="text-xs text-indigo-300 light:text-indigo-600 mt-0.5 italic">{tp.suggestedApproach}</p>
                      )}
                    </div>
                  </li>
                ))}
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-700/30 light:border-gray-200">
            ...
            {briefing.meetingUrl && (
              <a
                ...
                className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium rounded-lg bg-indigo-500/15 text-indigo-400 border border-indigo-500/20 hover:bg-indigo-500/25 transition-colors"
              >
                Join Meeting
                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
