    ...
    <div className="glass-card border border-white/[0.06] light:border-gray-200 rounded-xl p-6 transition-colors duration-200 hover:border-gray-600 light:hover:border-gray-300 light:shadow-sm">
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          disabled={saving}
          className={`
            w-full text-left p-4 rounded-lg border transition-colors duration-200 outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]
            ${preference === 'review'
