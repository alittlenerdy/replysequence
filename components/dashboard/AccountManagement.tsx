              ...
              <div className="mt-3 p-4 bg-red-500/5 border border-red-500/20 rounded-lg">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="px-3 py-1.5 text-sm bg-gray-800 light:bg-gray-100 border border-gray-700 light:border-gray-300 rounded-lg text-white light:text-gray-900 placeholder-gray-600 light:placeholder-gray-400 w-32 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18] light:focus-visible:ring-offset-white"
                  />
                  <button
