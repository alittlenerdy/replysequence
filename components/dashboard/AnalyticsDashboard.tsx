...
export function AnalyticsDashboard() {
  ...
  if (loading) {
    return (
      <div className="space-y-6">
        ...
        {/* Banner skeleton */}
        <div className="h-16 bg-gray-900/60 border border-[#1E2A4A] light:bg-white light:border-gray-200 rounded-xl animate-pulse" />
        {/* KPI row skeleton */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="bg-gray-900/60 border border-[#1E2A4A] light:bg-white light:border-gray-200 rounded-2xl p-5 animate-pulse">
        ...
        {/* At-risk skeleton */}
        <div className="bg-gray-900/60 border border-[#1E2A4A] light:bg-white light:border-gray-200 rounded-2xl p-6 h-[160px] animate-pulse" />
        {/* Charts skeleton */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {[...Array(2)].map((_, i) => (
            <div key={i} className="bg-gray-900/60 border border-[#1E2A4A] light:bg-white light:border-gray-200 rounded-2xl p-6 h-[220px] animate-pulse">
    ...
    return (
      <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-8 text-center">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 rounded-lg transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]"
        >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-2xl font-bold text-white light:text-gray-900">
            <span className="bg-gradient-to-r from-[#6366F1] to-[#4F46E5] bg-clip-text text-transparent">Analytics</span>
          </h2>
          {lastUpdated && (
        ...
        <div className="flex items-center gap-2">
          {/* Date range pills */}
          <div className="flex items-center bg-gray-800/50 light:bg-gray-100 rounded-lg p-0.5">
            {DATE_RANGES.map((range) => (
              <button
                key={range.value}
                onClick={() => setDateRange(range.value)}
                className={`px-3 py-1.5 text-xs font-medium rounded-md transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18] ${
      ...
      {/* Empty state */}
      {!hasData && (
        <div className="bg-gray-900/60 border border-[#1E2A4A] light:bg-white light:border-gray-200 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
          <div className="relative">
            <div className="relative mx-auto w-32 h-32 mb-6">
              <motion.div
                ...
                className="relative w-32 h-32 bg-gradient-to-br from-[#6366F1] to-[#3A4BDD] rounded-full flex items-center justify-center shadow-lg"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-[#4F46E5] to-[#2A3ACC] rounded-xl hover:from-[#3A4BDD] hover:to-[#1C2545] transition-colors outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]"
              >
            ...
            <div className="pt-8 border-t border-[#1E2A4A] light:border-gray-200">
              <p className="text-xs text-gray-500 uppercase tracking-wider mb-4">What you will unlock</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { icon: <Shield className="w-5 h-5" />, label: 'Coverage Tracking', color: 'text-[#6366F1]' },
                  { icon: <Mail className="w-5 h-5" />, label: 'Email Metrics', color: 'text-[#6366F1]' },
