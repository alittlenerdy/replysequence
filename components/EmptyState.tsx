        ...
        <div className="mt-10 pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center">
            <div className="flex items-start gap-3 text-left max-w-xs">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Record a meeting</p>
                <p className="text-xs text-gray-500">Enable cloud recording with audio transcript in Zoom</p>
              </div>
            </div>
            <div className="flex items-start gap-3 text-left max-w-xs">
              <div className="flex-shrink-0 w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-sm font-bold">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">AI analyzes transcript</p>
                <p className="text-xs text-gray-500">Claude extracts key points and action items</p>
              </div>
            </div>
            <div className="flex items-start gap-3 text-left max-w-xs">
              <div className="flex-shrink-0 w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-sm font-bold">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Edit the draft if needed, then send with one click</p>
              </div>
            </div>
          </div>
        </div>
