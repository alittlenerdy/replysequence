...
const COLORS = ['#6366F1', '#818CF8', '#a5b4fc', '#FF9D2D', '#FF9D2D', '#4F46E5'];
        ...
        {showCheckmark && (
          ...
          >
            <motion.div
              ...
              className="w-20 h-20 rounded-full bg-gradient-to-br from-[#6366F1] to-[#4F46E5] flex items-center justify-center shadow-2xl shadow-[#6366F1]/40"
            >
              <motion.div
