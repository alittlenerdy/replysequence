...
const ICON_COLORS: Record<string, string> = {
  ...
  client: 'text-[#6366F1] bg-[#6366F1]/20 border-[#6366F1]/30',
  technical: 'text-[#6366F1] bg-[#6366F1]/20 border-[#6366F1]/30',
        ...
        {templates.map((template) => {
          ...
          return (
            <button
              ...
              className={`
                text-left p-3 rounded-lg border transition-[border-color,background-color,box-shadow] duration-200 outline-none focus-visible:ring-2 focus-visible:ring-[#6366F1]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060B18]
                ${isSelected
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {isSelected && (
                      <svg className="w-4 h-4 text-[#6366F1] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
