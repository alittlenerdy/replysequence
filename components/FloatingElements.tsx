...
export default function FloatingElements() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ contain: 'layout style paint' }}>
      <div
        className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#5B6CFF]/10 light:bg-[#5B6CFF]/30 rounded-full blur-3xl animate-pulse-slow will-change-transform"
        style={{ contain: 'layout' }}
      />
      <div
        className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#5B6CFF]/10 light:bg-[#5B6CFF]/30 rounded-full blur-3xl animate-pulse-slow will-change-transform"
